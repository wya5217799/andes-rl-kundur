...
def _frozen_contract_checks(contract) -> None:
    ...
    assert contract["highpass_alpha"] == 0.90
...
def test_build_contract_freezes_gate_b3_values() -> None:
...
def test_phase_jobs_match_frozen_record_counts() -> None:
    ...
    evaluation = phase_jobs(
        "evaluation",
        selected_arm_id="distributed_lowhp_damping_ks1_kc1_alpha0p9",
        contract=contract,
    )
...
def test_controller_spec_resolves_all_arms() -> None:
    ...
    for candidate in contract["distributed_candidates"]:
        ...
        assert spec["architecture"] == "distributed_lowhp_damping"
...
def test_selection_accepts_candidate_beating_local_primary() -> None:
    ...
    summaries = {
        ...
        "distributed_lowhp_damping_ks0p5_kc0p5_alpha0p9": candidate,
        "distributed_lowhp_damping_ks0p5_kc1_alpha0p9": candidate,
        "distributed_lowhp_damping_ks1_kc0p5_alpha0p9": candidate,
        "distributed_lowhp_damping_ks1_kc1_alpha0p9": candidate,
    }
...
def test_classify_returns_stop_when_baseline_guards_fail() -> None:
    ...
    evaluation = {
        ...
        "distributed_lowhp_damping_ks1_kc1_alpha0p9": _summary_placeholder(
            guards_pass=True
        ),
    }
