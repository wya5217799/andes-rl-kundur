"""R377 Gate B-2 frozen contract, guards, endpoints, and classification.

This module holds the byte-frozen R377 successor contract from
...
SELECTED_ARM = "selected_distributed_hp_damping"
HIGH_PASS_ALPHA = 0.60
...
def build_contract() -> dict[str, Any]:
    ...
    return {
        ...
        "development": {
            ...
            "probe_condition": {
                "condition_id": "dev2_probe_pq0_minus_0p45",
                "delta_u": {"PQ_0": -0.45},
            },
            "disturbance_conditions": [
                {
                    "condition_id": "dev2_disturbance_pq1_plus_0p60",
                    "delta_u": {"PQ_1": 0.60},
                },
                {
                    "condition_id": "dev2_disturbance_bus15_plus_0p50",
        ...
        "evaluation": {
            ...
            "probe_condition": {
                "condition_id": "eval2_probe_pq0_plus_0p40",
                "delta_u": {"PQ_0": 0.40},
            },
            "disturbance_conditions": [
                {
                    "condition_id": "eval2_disturbance_bus14_minus_0p55",
                    "delta_u": {"PQ_Bus14": -0.55},
                },
                {
                    "condition_id": "eval2_disturbance_pq1_minus_0p70",
                    "delta_u": {"PQ_1": -0.70},
                },
            ],
