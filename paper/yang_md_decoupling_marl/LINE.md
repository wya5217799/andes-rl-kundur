...
status: active
priority: 4
stage: learning-tail-evaluation-preparation
...
objective: "R483 complete. Authorized evaluation-only successor: 208 finals plus frozen deterministic/zero, 30 s full guards; no retraining/tuning."
...
verification: ["R483 sealed; 6 s primary and 30 s sensitivity stay non-pooled."]
stop_when: ["Successor requires dual review, preflight, approval, rehearsal, capacity and seal; drift stops."]
---
